...
| :--- | :--- | :--- | :--- | :--- |
| **data** | Cube (deprecated; don't use) data | | Cube (deprecated; don't use) object data properties as defined below | Yes |
...
| **jitsi-video** | [JitsiVideo](JitsiVideo) |  | Apply a jitsi video source to the geometry. | No |
