...
User Camera is the pose and arena-user component data representing a user avatar.

All wire objects have a set of basic attributes ```{object_id, action, type, persist, data}```. The ```data``` attribute defines the object-specific attributes

User Camera Attributes
-----------------------
...
|data|User Camera data||User Camera Data|Yes|

### User Camera Data Attributes
