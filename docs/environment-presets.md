...
|dressingVariance|See: [Vector3.md](Vector3.md)|Vector3|```{'x': 1, 'y': 1, 'z': 1}```|No|
...
|groundScale|See: [Vector3.md](Vector3.md)|Vector3|```{'x': 1, 'y': 1, 'z': 1}```|No|
...
|lightPosition|See: [Vector3.md](Vector3.md)|Vector3|```{'x': 0, 'y': 1, 'z': -0.2}```|No|
